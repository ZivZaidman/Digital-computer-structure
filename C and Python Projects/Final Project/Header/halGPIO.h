...
extern void ackTimerA0_ms(unsigned int counter);
extern char Rec_data[80];
extern int file_uploaded_ind;
extern int file_execute_ind;
...
#define lcd_cursor_16(x)       lcd_cmd(((x)&0x7F)|0xC0)
