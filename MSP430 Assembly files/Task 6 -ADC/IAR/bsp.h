...
// LCDs abstraction
#define LCDsDataArrPort        &P2OUT
#define LCDsDataArrPortSel     &P2SEL
#define LCDsDataArrPortDir     &P2DIR
#define LCDsControlArrPort     &P1OUT
#define LCDsControlArrSel      &P1SEL
#define LCDsControlArrPortDir  &P1DIR
#define LCDe               0x20
#define LCDrs              0x40
#define LCDrw              0x80
